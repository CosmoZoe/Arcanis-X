...
mods.immersiveengineering.ArcFurnace.addRecipe(<minecraft:redstone>*8, <ore:clathrateRedstone>, <gregtech:meta_item_1:2328>, 2000, 512);
mods.immersiveengineering.ArcFurnace.addRecipe(<thermalfoundation:glass:3>, <ore:dustObsidian>*4, null, 2000, 512, [<ore:dustSaltpeter>]);

mods.immersiveengineering.Squeezer.addRecipe(null, <liquid:mercury>*144, <ore:quicksilver>, 512);
mods.immersiveengineering.Squeezer.addRecipe(null, <liquid:mercury>*16, <ore:nuggetQuicksilver>, 96);